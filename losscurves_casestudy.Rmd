...
```{r model_sislob_grcode353_wb_fit, echo=TRUE, results='hide', warning=TRUE}
...
```{r model_sislob_grcode353_ll_fit, echo=TRUE, results='hide', warning=TRUE}
...
```{r session_info, echo=TRUE, message=TRUE}
...
The code and text are copyrighted by Michael Cooney and licensed under
[BSD (3-clause)](https://opensource.org/licenses/BSD-3-Clause) and the text is
