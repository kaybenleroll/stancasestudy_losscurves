...
Rather than go through a comprehensive list of diagnostic plots, we look at
a smaller selection of them for the interests of brevity.
...
As before, we first check the output to ensure that our sample does not
contain any obvious biases.
